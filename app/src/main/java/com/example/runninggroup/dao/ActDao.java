...
public class ActDao {
     ...
     * 根据时间戳区间得出跑步总里程
     */
    public static String selectLenByTime (int user_id, String start, String end) {
        String res = PostRequest.postRequest(ConstantUtil.URL + ConstantUtil.SELECT_LEN_BY_TIME, "user_id=" + user_id + "&start=" + start + "&end=" + end);
        return res;
