package com.example.runninggroup.test;
...
public class TestLy extends Activity implements
    ...
    private final int IMAGE_OPEN = 4; // 打开图片标记f
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_testly_activity);
        init();
        initData();
    }
    private void init() {
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
        ...
        if (imageItem.size() == 10) { // 第一张为默认图片
            Toast.makeText(TestLy.this, "图片数9张已满",
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new Builder(TestLy.this);
